...
function DetailModalBody({ handleClose }) {
  ...
  const [textArea, setTextArea] = useState(postDetail.postContent);
  ...
  const completeUpdatePost = () => {
    ...
    } else if (textArea !== postDetail.postContent) {
      dispatch(
        __updateMyPost({
          content: textArea,
  ...
  const cancelUpdatePost = (event) => {
    setTextArea(postDetail.postContent);
    setShowUpdateForm(false);
  };
  return (
    <>
        ...
        <StContentsContainer>
          ...
          <StDetailBodyContainer>
            ...
            <div className="titleRowBox">
              ...
              >
                <StButtonCRUD
                  ...
                  onClick={
                    showUpdateForm ? completeUpdatePost : handleUpdatePost
                  }
                  type="submit"
                >
            ...
            {!showUpdateForm ? (
              ...
              <>
                <StUpdatePostWrap showOrHide={showUpdateForm}>
                  <textarea
